...
let newsListMock: NewsList = [
    News(_id: "1c3sYHXNIo1sHCzp0tlh",
        id: "1c3sYHXNIo1sHCzp0tlh",
         ...
         description: "Stack Sms es un proyecto en el que llevamos trabajando ya un tiempo en Ideas Locas. \nEl concepto básico es dar capacidades parecidas a la pila TCP en la red Gsm a través de Sms. Además podemos encapsular otros protocolos encima de Stack Sms para que se ajuste a multiples necesidades.\nFran, un compañero de Ideas Locas ha escrito un excelente artículo explicando un poco el protocolo, como descargarlo y casos de uso útiles. Es un proyecto bastante singular y merece la pena echarle un ojo, así que os animo a leer el artículo e ir al github oficial.",
         description_en: "Stack Sms es un proyecto en el que llevamos trabajando ya un tiempo en Ideas Locas. \nEl concepto básico es dar capacidades parecidas a la pila TCP en la red Gsm a través de Sms. Además podemos encapsular otros protocolos encima de Stack Sms para que se ajuste a multiples necesidades.\nFran, un compañero de Ideas Locas ha escrito un excelente artículo explicando un poco el protocolo, como descargarlo y casos de uso útiles. Es un proyecto bastante singular y merece la pena echarle un ojo, así que os animo a leer el artículo e ir al github oficial.",
